...
if {!($type_template == "SOC")} {
	error " -E- This function can be used only for SOC template. Consider using ip_prototype_test function or change to SOC template"ex
	incr error
}
