...
//Input vectors size:
#define X_IN_LENGTH 2
//Output vectors size:
#define U_OUT_LENGTH 1
...
int write_stimuli(double input_data[], unsigned packet_internal_ID)
{
	...
	{
	case 0: //x_in
		// store x_in into ../../ip_design/test/stimuli/eMPC_controller/x_in.dat
		pFile = fopen ("../../ip_design/test/stimuli/eMPC_controller/x_in.dat","w+");
...
{
	system("vivado_hls -f ../../.metadata/eMPC_controller_ip_design_test.tcl");
}
...
int read_results(double output_data[], unsigned packet_internal_ID, unsigned packet_output_size)
{
	...
	{
	case 0: //u_in
		// load ../../ip_design/test/results/eMPC_controller/u_out.dat
		pFile = fopen ("../../ip_design/test/results/eMPC_controller/u_out.dat","r");
