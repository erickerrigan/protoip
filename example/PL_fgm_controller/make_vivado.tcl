# to test the FGM algorithm with the HIL experimental setup, run from Xilinx Vivado
...
tclapp::icl::protoip::ip_prototype_test -project_name fgm_controller -board_name zedboard -num_test 1000