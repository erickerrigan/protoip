%% Make the required data input files
make_rand_stimuli('project_name','lqr_controller');


%% to test the LQR algorithm with the HIL experimental setup, run from Matlab

ip_design_test('project_name','lqr_controller','type_test','c');
ip_design_test('project_name','lqr_controller','type_test','xsim');
